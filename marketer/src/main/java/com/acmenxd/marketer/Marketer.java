...
/**
 * @detail 集中快速打包 & 获取渠道信息
 */
public final class Marketer {
    private final String TAG = this.getClass().getSimpleName();
    private static final String USAGE_TEXT = "Usage: java -jar MarketUtils.jar apkFile marketFile [outputDir] ";
    ...
    private static class UnicodeReader extends Reader {
         ...
         * @param defaultEnc default encoding if stream does not have BOM marker. Give
